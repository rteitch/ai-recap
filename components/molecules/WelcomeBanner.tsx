  ...
  return (
    <div className="m-3 sm:m-4 p-4 sm:p-5 rounded-xl border border-highlight/30 bg-gradient-to-br from-[#1c1d29] to-[#14151e] shadow-xl text-ink-100 relative group animate-fade-in">
      ...
      <div className="flex items-start gap-3">
        <div className="w-10 h-10 rounded-lg bg-highlight-soft border border-highlight/40 flex items-center justify-center text-highlight flex-shrink-0 mt-0.5">
        ...
        <div className="space-y-1 pr-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono px-1.5 py-0.2 rounded bg-highlight/15 text-highlight border border-highlight/40 font-semibold">
              Beginner Guide
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mt-4 pt-3 border-t border-ink-800/80 text-xs">
        <div className="p-2.5 rounded-lg bg-ink-900/60 border border-ink-800/80 space-y-1">
          ...
          <p className="text-[11px] text-ink-400 leading-normal">
            Type notes, drop files (.md/.txt), or use LaTeX math (<code className="text-highlight font-mono">\</code>) and Mermaid diagrams.
          </p>
        </div>
        ...
        <div className="p-2.5 rounded-lg bg-ink-900/60 border border-ink-800/80 space-y-1">
          ...
          <p className="text-[11px] text-ink-400 leading-normal">
            Hit the <strong className="text-highlight font-medium">AI Recap</strong> button (or Ctrl+Enter) to generate your core concepts.
          </p>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-2 mt-4">
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-highlight hover:bg-highlight-hover text-highlight-text font-bold text-xs transition-colors flex items-center gap-1.5 shadow-sm"
        >
