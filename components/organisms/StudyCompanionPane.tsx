    ...
    >
      ...
      <div className="h-11 px-3.5 flex items-center justify-between border-b border-ink-800/80 bg-app-bg">
        <div className="flex items-center gap-2">
          ...
          {loading && (
            <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-yellow-400/15 text-yellow-300 border border-yellow-400/30 animate-pulse flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-yellow-400 animate-ping" />
              Recapping...
            </span>
          )}
          {result && !loading && (
            <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-yellow-400/15 text-yellow-300 border border-yellow-400/30">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5 scrollbar-thin select-text">
        ...
        {loading && (
          <div className="space-y-4 py-2" aria-busy="true">
            ...
            <div className="p-4 rounded-xl bg-yellow-400/10 border border-yellow-400/30 text-center space-y-2.5 shadow-[0_0_20px_rgba(245,197,24,0.08)]">
              ...
              <div className="space-y-1">
                <h3 className="text-xs font-bold text-yellow-400 uppercase tracking-wider font-mono">
        ...
        {result && !loading && (
          <>
            ...
            <div className="space-y-3">
                    ...
                    <div className="relative inline-flex items-center" ref={regenMenuRef}>
                      <div className="inline-flex items-center rounded-md bg-ink-900 border border-ink-750 overflow-hidden text-[11px]">
                        <button
                          ...
                          className="px-2 py-0.5 text-yellow-400 hover:text-yellow-300 hover:bg-ink-800 font-medium transition-colors flex items-center gap-1 disabled:opacity-50"
                          title={`Regenerate ${selectedRegenCount} new questions`}
                        >
                          <svg
                            className={`w-3 h-3 ${isRegeneratingQuiz ? "animate-spin text-yellow-400" : ""}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
              ...
              {isRegeneratingQuiz && (
                <div className="p-2.5 rounded-lg bg-yellow-400/10 border border-yellow-400/30 text-yellow-300 text-xs flex items-center justify-center gap-2 animate-pulse font-mono">
                  <svg className="w-3.5 h-3.5 animate-spin text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                  </svg>
