      ...
      <div className="mt-3 flex flex-wrap items-center justify-center gap-2 no-print">
        ...
        {onUpdateStatus && missedCount > 0 && studyStatus !== "perlu-diulang" && (
          <button
            ...
            className="text-xs bg-amber-400/15 hover:bg-amber-400/25 text-amber-300 border border-amber-400/40 rounded px-2.5 py-1.5 transition-colors touch-manipulation inline-flex items-center gap-1.5 font-medium"
