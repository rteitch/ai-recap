...
export const MenuBar = memo(function MenuBar(props: MenuBarProps) {
  const {
    ...
    onNewNote, onSaveDraft, onImportFile, onExportPdf, onExportMarkdown, onClearNote,
        ...
        <div key={id} className="relative">
          ...
          {activeMenu === "file" && id === "file" && (
            <div className={dp} role="menu">
              ...
              <MenuItem label="Export Note as Markdown (.md)" onClick={act(onExportMarkdown)} disabled={!hasNotes}
                icon={<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>} />
              <MenuDivider />
