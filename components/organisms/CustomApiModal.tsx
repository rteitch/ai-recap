          ...
          {provider === "default" ? (
            ...
            <>
              ...
              <div className="space-y-1">
                ...
                <div className="mt-1 text-[11px] bg-amber-900/40 border border-amber-500/40 text-amber-300 rounded-lg p-2">
                  Key disimpan plaintext di browser. Gunakan key khusus, jangan key production.
                </div>
              </div>
